...
#
# Script generated by Vivado on Sun May 19 19:53:13 +0200 2024
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_interval_minmax:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
